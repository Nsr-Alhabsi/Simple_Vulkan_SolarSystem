...
#define SYNC_PUSH(field, vector) if(writeToSOA) vector.push_back(field);
  ...
  if (writeToSOA && (size_t)idx == ANIMATION_SOA_VECTOR_ANIMATION_TYPE.size()) {
    ...
    SYNC_PUSH(props.ANIMATION_DURATION, ANIMATION_SOA_VECTOR_ANIMATION_DURATION);
    SYNC_PUSH(props.ANIMATION_DELAY, ANIMATION_SOA_VECTOR_ANIMATION_DELAY);
    SYNC_PUSH(0.f, ANIMATION_SOA_VECTOR_ANIMATION_ELAPSED_TIME);
    SYNC_PUSH(0.f, ANIMATION_SOA_VECTOR_ANIMATION_ELAPSED_DELAY_TIME);
    SYNC_PUSH(props.ANIMATION_REPETITION, ANIMATION_SOA_VECTOR_ANIMATION_REPETITION);
    SYNC_PUSH(false, ANIMATION_SOA_VECTOR_ANIMATION_DELAY_FINISHED);
    SYNC_PUSH(props.ANIMATION_REVERSE_ON_FINISH, ANIMATION_SOA_VECTOR_ANIMATION_REVERSE_ON_FINISH);
    ...
    if (props.TYPE == ANIMATION_TYPE_ROTATION) {
      SYNC_PUSH(props.ANIMATION_TYPE_ROTATION.ANIMATION_STARTING_RADIAN, ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_STARTING_RADIAN);
      SYNC_PUSH(props.ANIMATION_TYPE_ROTATION.PIVOT_POINT, ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_PIVOT_POINT);
      SYNC_PUSH(props.ANIMATION_TYPE_ROTATION.ANIMATION_ENDING_RADIAN, ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_ENDING_RADIAN);
      SYNC_PUSH(props.ANIMATION_TYPE_ROTATION.RADIUS, ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_RADIUS);
    } else {
    ...
    if (props.TYPE == ANIMATION_TYPE_TRANSLATION) {
      SYNC_PUSH(props.ANIMATION_TYPE_TRANSLATION.ANIMATION_STARTING_POSITION, ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_STARTING_POSITION);
      SYNC_PUSH(props.ANIMATION_TYPE_TRANSLATION.ANIMATION_ENDING_POSITION, ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_ENDING_POSITION);
      SYNC_PUSH(props.ANIMATION_TYPE_TRANSLATION.IS_RELATIVE, ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_IS_RELATIVE);
    } else {
    ...
    if (props.TYPE == ANIMATION_TYPE_SCALE) {
      SYNC_PUSH(props.ANIMATION_TYPE_SCALE.ANIMATION_STARTING_SCALE_VECTOR, ANIMATION_SOA_VECTOR_SCALING_ANIMATION_STARTING_SCALE_VECTOR);
      SYNC_PUSH(props.ANIMATION_TYPE_SCALE.ANIMATION_ENDING_SCALE_VECTOR, ANIMATION_SOA_VECTOR_SCALING_ANIMATION_ENDING_SCALE_VECTOR);
    } else {
    ...
    SYNC_VAL(props.ANIMATION_DURATION, ANIMATION_SOA_VECTOR_ANIMATION_DURATION);
    SYNC_VAL(props.ANIMATION_DELAY, ANIMATION_SOA_VECTOR_ANIMATION_DELAY);
    SYNC_VAL(props.ANIMATION_ELAPSED_TIME, ANIMATION_SOA_VECTOR_ANIMATION_ELAPSED_TIME);
    SYNC_VAL(props.ANIMATION_ELAPSED_DELAY_TIME, ANIMATION_SOA_VECTOR_ANIMATION_ELAPSED_DELAY_TIME);
    SYNC_VAL(props.ANIMATION_REPETITION, ANIMATION_SOA_VECTOR_ANIMATION_REPETITION);
    SYNC_VAL(props.ANIMATION_DELAY_FINISHED, ANIMATION_SOA_VECTOR_ANIMATION_DELAY_FINISHED);
    SYNC_VAL(props.ANIMATION_REVERSE_ON_FINISH, ANIMATION_SOA_VECTOR_ANIMATION_REVERSE_ON_FINISH);
    ...
    if (writeToSOA) {
      if (props.TYPE == ANIMATION_TYPE_ROTATION) {
        ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_STARTING_RADIAN[idx] = props.ANIMATION_TYPE_ROTATION.ANIMATION_STARTING_RADIAN;
        ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_PIVOT_POINT[idx] = props.ANIMATION_TYPE_ROTATION.PIVOT_POINT;
        ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_ENDING_RADIAN[idx] = props.ANIMATION_TYPE_ROTATION.ANIMATION_ENDING_RADIAN;
        ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_RADIUS[idx] = props.ANIMATION_TYPE_ROTATION.RADIUS;
      } else if (props.TYPE == ANIMATION_TYPE_TRANSLATION) {
        ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_STARTING_POSITION[idx] = props.ANIMATION_TYPE_TRANSLATION.ANIMATION_STARTING_POSITION;
        ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_ENDING_POSITION[idx] = props.ANIMATION_TYPE_TRANSLATION.ANIMATION_ENDING_POSITION;
        ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_IS_RELATIVE[idx] = props.ANIMATION_TYPE_TRANSLATION.IS_RELATIVE;
      } else if (props.TYPE == ANIMATION_TYPE_SCALE) {
        ANIMATION_SOA_VECTOR_SCALING_ANIMATION_STARTING_SCALE_VECTOR[idx] = props.ANIMATION_TYPE_SCALE.ANIMATION_STARTING_SCALE_VECTOR;
        ANIMATION_SOA_VECTOR_SCALING_ANIMATION_ENDING_SCALE_VECTOR[idx] = props.ANIMATION_TYPE_SCALE.ANIMATION_ENDING_SCALE_VECTOR;
      }
    } else {
      props.ANIMATION_TYPE_ROTATION.ANIMATION_STARTING_RADIAN = ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_STARTING_RADIAN[idx];
      props.ANIMATION_TYPE_ROTATION.PIVOT_POINT = ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_PIVOT_POINT[idx];
      props.ANIMATION_TYPE_ROTATION.ANIMATION_ENDING_RADIAN = ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_ENDING_RADIAN[idx];
      props.ANIMATION_TYPE_ROTATION.RADIUS = ANIMATION_SOA_VECTOR_ROTATION_ANIMATION_RADIUS[idx];
      props.ANIMATION_TYPE_TRANSLATION.ANIMATION_STARTING_POSITION = ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_STARTING_POSITION[idx];
      props.ANIMATION_TYPE_TRANSLATION.ANIMATION_ENDING_POSITION = ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_ENDING_POSITION[idx];
      props.ANIMATION_TYPE_TRANSLATION.IS_RELATIVE = ANIMATION_SOA_VECTOR_TRANSLATION_ANIMATION_IS_RELATIVE[idx];
      props.ANIMATION_TYPE_SCALE.ANIMATION_STARTING_SCALE_VECTOR = ANIMATION_SOA_VECTOR_SCALING_ANIMATION_STARTING_SCALE_VECTOR[idx];
      props.ANIMATION_TYPE_SCALE.ANIMATION_ENDING_SCALE_VECTOR = ANIMATION_SOA_VECTOR_SCALING_ANIMATION_ENDING_SCALE_VECTOR[idx];
    }
  }
#undef SYNC_VAL
#undef SYNC_PUSH
